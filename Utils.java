public class Utils {
    ...
    public static String gerarMensagemAjuda(boolean isAdmin) {
        ...
        helpMsg.append(" /salas                       -> Lista as salas disponiveis\n");
        ...
        if (isAdmin) {
            ...
            helpMsg.append(" /expulsar <usuario>          -> Expulsa um usuario da sala\n");
            helpMsg.append(" /encerrar <nome_da_sala>     -> Encerra uma sala existente\n");
        }

        helpMsg.append(" /sairServidor                -> Encerra sua conexao com o servidor\n");
